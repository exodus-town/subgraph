...
export class AuctionReset extends ethereum.Event {
  get params(): AuctionReset__Params {
    return new AuctionReset__Params(this);
  }
}

export class AuctionReset__Params {
  _event: AuctionReset;

  constructor(event: AuctionReset) {
    this._event = event;
  }
...
export class AuctionHouse__auctionResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class AuctionHouse extends ethereum.SmartContract {
  ...
  try_auction(): ethereum.CallResult<AuctionHouse__auctionResult> {
    ...
    return ethereum.CallResult.fromValue(
      new AuctionHouse__auctionResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  mana(): Address {
    let result = super.call("mana", "mana():(address)", []);

    return result[0].toAddress();
  }

  try_mana(): ethereum.CallResult<Address> {
    let result = super.tryCall("mana", "mana():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  town(): Address {
    let result = super.call("town", "town():(address)", []);

    return result[0].toAddress();
  }

  try_town(): ethereum.CallResult<Address> {
    let result = super.tryCall("town", "town():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
