...
export class ExodusDAO__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class ExodusDAO__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class ExodusDAO extends ethereum.SmartContract {
  static bind(address: Address): ExodusDAO {
    return new ExodusDAO("ExodusDAO", address);
  }
  ...
  eip712Domain(): ExodusDAO__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new ExodusDAO__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<ExodusDAO__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      []
    ...
    return ethereum.CallResult.fromValue(
      new ExodusDAO__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  proposalVotes(proposalId: BigInt): ExodusDAO__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new ExodusDAO__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_proposalVotes(
    proposalId: BigInt
  ): ethereum.CallResult<ExodusDAO__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ExodusDAO__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  quorum(timestamp: BigInt): BigInt {
  ...
  try_quorum(timestamp: BigInt): ethereum.CallResult<BigInt> {
